...
namespace Illumina.BaseSpace.SDK.Tests.Helpers
{
    public class TestHelpers : BaseIntegrationTest
    {
        ...
        private static string CreateRandomTestProjectName()
        {
            return string.Format(TestProjectNameFormatString, StringHelpers.RandomAlphanumericString(5));
        }
        ...
        private static string CreateRandomTestAppResultName()
        {
            return string.Format(TestAppResultNameFormatString, StringHelpers.RandomAlphanumericString(5));
        }
        ...
        internal static LibraryContainer CreateContainerLibraries(IBaseSpaceClient client, int libraryCount)
        {
            ...
            client.CreateOrUpdateContainerLibraries(new CreateOrUpdateContainerLibrariesRequest(libraryRequests,
                container.Id));
            ...
            Assert.Equal(sampleLibraries.FirstOrDefault().BiologicalSample.Id,
                libraryRequests.FirstOrDefault().BiologicalSampleId);
            return container;
        }
