...
namespace Illumina.BaseSpace.SDK
{
    public class FileUpload
    {
        ...
        protected virtual Types.File UploadFile_MultiPart<T>(FileInfo fileToUpload, string resourceId, string resourceIdentifierInUri, string directory, int numThreads) 
			where T : FileUploadRequestBase, new()
        {
	        throw new NotImplementedException();
